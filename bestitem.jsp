...
<div class = "row">
	<div class = "small-12 medium-6 column">
		...
		<p>이번에 발표한 제품들은 맥을 위해 애플이 새롭게 설계한 칩 패밀리 중 첫 번째인 M1이 탑재된 것이 큰 특징이다.</p>
		<p>애플이 제작한 역대 가장 강력한 칩인 M1은 뛰어난 와트당 성능을 통해 맥 OS 빅서(Big Sur)와 함께 사용시 기존 대비 최대 3.5배 빠른 CPU, 최대 6배 빠른 GPU, 최대 15배 빠른 머신 러닝(ML) 역량, 그리고 최대 2배 길어진 배터리 사용 시간을 제공한다. </p>
		<p>사용자들은 맥을 위한 사상 최대의 앱 컬렉션을 이용할 수 있으며, M1을 탑재한 맥의 새로운 라인업은 빼어난 성능과 뛰어난 새 기능을 선보인다.</p>
		<p>맥북 에어는 애플 제품 중 가장 인기 있는 제품으로, 전세계에서 가장 많이 팔린 13형 노트북이다. 이번에 M1 칩을 탑재한 맥북 에어는 가족 사진을 편집하는 작업부터 동영상을 웹으로 내보내는 작업에 이르기까지 처리 속도가 빨라졌다. </p>
	</div> 
</div>
