...
<%
	...
	try{
		...
		DataSource ds = (DataSource)init.lookup("java:comp/env/jdbc/worldpicture");
...
%>
			<td id = "td_style">			
			 	<img id="img_style" src="./img/<%=rs.getString("p_fileName")%>" >
				<h3><%=rs.getString("p_name")%></h3>				
				<p><%=rs.getString("p_unitPrice")%>원
				<p><a href="./product.jsp?id=<%=rs.getString("p_id")%>">상세 정보 &raquo;</a>			
			</td>
<% 
			if(cnt%4==0){ 
				cnt=0;
